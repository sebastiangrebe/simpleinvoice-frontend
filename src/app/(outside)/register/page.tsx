...
import { UserRegisterAuthForm } from "@/components/auth/UserRegisterAuthForm";
...
export default function AuthenticationPage() {
  return (
    <div className="container relative md:min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 py-12 md:py-0">
      ...
      <div className="relative h-full w-full flex-col bg-muted p-10 hidden md:text-white dark:border-r lg:flex">
        <div className="absolute inset-0 bg-white lg:bg-gradient-to-b from-primary/60 to-primary" />
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;We are building your business. Stable technologies with
              innovative solutions.&rdquo;
            </p>
