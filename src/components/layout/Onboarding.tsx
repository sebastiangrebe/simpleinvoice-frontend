...
export default function OnboardingPage() {
  return (
    <div className="py-36 mx-44 flex items-center justify-center">
      <div className=" font-[sans-serif] p-6">
      <div className="grid lg:grid-cols-2 items-center gap-16 max-w-7xl mx-auto min-h-[350px]">
        <div>
          <h3 className="text-white text-4xl font-bold">Subscribe to Our Invoice Generator</h3>
          <p className="text-base mt-6 text-gray-300">Subscribe to our Invoice Generator,
          Effortlessly create professional invoices in seconds – streamline your billing with ease!</p>
          <div className="bg-transparent border border-gray-500 flex p-1 rounded-full mt-12">
            ...
            <Button type='button'
              className="transition-all text-white text-sm rounded-full px-6 py-3">Submit</Button>
          </div>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          <div className='bg-gray-950 p-6 rounded-lg border-[2px] hover:border-purple-600  border-slate-200  '>
            <svg xmlns="http://www.w3.org/2000/svg" className="fill-blue-600 w-12 mb-6 inline-block border border-gray-500 p-3 rounded-md" viewBox="0 0 32 32">
          ...
          <div className='bg-gray-950 p-6 rounded-lg border-[2px] hover:border-purple-600  border-slate-200 '>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 mb-6 inline-block border border-gray-500 p-3 rounded-md" viewBox="0 0 682.667 682.667">
              <defs>
